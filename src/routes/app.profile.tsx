      ...
      <Card className="mb-6 overflow-hidden border-blue-200/70">
        ...
        <CardContent className="pt-0">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6">
            <QuickStat icon={<Briefcase className="h-4 w-4" />} label="Designation" value={currentUser.designation || "—"} />
            <QuickStat icon={<Building2 className="h-4 w-4" />} label="Department" value={currentUser.department || "—"} />
            <QuickStat icon={<IdCard className="h-4 w-4" />} label="Manager" value={currentUser.manager || "—"} />
            <QuickStat icon={<HeartPulse className="h-4 w-4" />} label="Blood group" value={currentUser.bloodGroup || "—"} />
          </div>
        </CardContent>
      </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Field label="Phone">
                <Input value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value })} disabled={isEmployee} />
              </Field>
        ...
        <Card>
          ...
          <CardContent>
            <p className="mb-4 rounded-md border border-blue-100 bg-blue-50 px-4 py-3 text-sm text-blue-700">
              Employment details can only be fully updated by Admin. Employees may update their reporting manager.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Field label="Employee ID">
                <Input value={form.employeeId} onChange={(e) => setForm({ ...form, employeeId: e.target.value })} disabled={isEmployee} />
              </Field>
              <Field label="Designation">
                <Input value={form.designation} onChange={(e) => setForm({ ...form, designation: e.target.value })} disabled={isEmployee} />
              </Field>
              <Field label="Department">
                <Input value={form.department} onChange={(e) => setForm({ ...form, department: e.target.value })} disabled={isEmployee} />
              </Field>
              <Field label="Reporting manager">
                <Input value={form.manager} onChange={(e) => setForm({ ...form, manager: e.target.value })} />
              </Field>
              <Field label="Joined date">
                <Input type="date" value={form.joinedDate} onChange={(e) => setForm({ ...form, joinedDate: e.target.value })} disabled={isEmployee} />
              </Field>
              <Field label="Role">
                <Select
                  value={form.role}
