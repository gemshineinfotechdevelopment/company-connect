...
exports.create = async (req, res) => {
  try {
    ...
    const { employeeId, name, email, password, phone, designation, department, role, dob, joiningDate, status } = req.body;
    ...
    const emp = new Employee({ employeeId, name, email, password: hashed, phone, designation, department, role, dob, joiningDate, status });
    await emp.save();
